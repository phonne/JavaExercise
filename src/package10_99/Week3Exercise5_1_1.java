...
public class Week3Exercise5_1_1 {
 ...
 */
    ...
    public static boolean isValid(Chessmen[][] chessboard, Chessmen atStart, int fromY, int fromX, int toY, int toX, int count) {

        if (isEmpty(chessboard, atStart, fromY, fromX, toY, toX)) {
            if (isDifferent(chessboard, fromY, fromX, toY, toX)) {
                if (rightTurn(chessboard, fromY, fromX, toY, toX, playerColour(count))) {
                    return true;
                }
    ...
    public static boolean rightTurn(Chessmen[][] chessboard, int fromY, int fromX, int toY, int toX, String player) {
        ...
        if (player == "Black" && black.contains(chessboard[fromX][fromY])) {
            System.out.println(player);
            return true;
        } else {
    ...
    public static int move(Chessmen[][] chessboard, String move, int count) {
        ...
        int toY = getIndexOf(components[1].charAt(0));
        int toX = getIndexOfN(components[1].charAt(1));
    ...
    public static void main(String[] args) {
        ...
        while (exit == false) {
            ...
            count = move(chessboard, input, count);
            printBoard(chessboard);
